...
<body>
	<div class="wrapper">
            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a href="{{  route('login') }}"  class="nav-link"><i class="fas fa-sign-in-alt"></i> Đăng nhập vào hệ thống</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        <div class="container mt-4 mb-4 logo">
            <a href="{{ route('index') }}">
                <h1 style="font-family: 'Exo 2', sans-serif; color: gray">CARS
                <span style="color: #f46164">STORE</span></h1>
            </a>
            <form method="POST" action="{{ route('search.car') }}" class="form-search" enctype="multipart/form-data">
				@csrf
				...
				<div class="row">
					...
					<div class="col-lg-3">
						...
						<div class="items">
							...
							<p><i class="fas fa-map-marker-alt"></i> Chuyên cho thuê xe</p>
						</div>
					</div>
					<div class="col-lg-3">
						<h6>LIÊN HỆ</h6>
	...
	<script type="text/javascript" src="{{asset('assets/js/validate-form.js')}}"></script>
</body>
